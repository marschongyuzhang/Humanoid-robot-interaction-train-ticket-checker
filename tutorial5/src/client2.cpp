...
// TODO: create function for each task
    ...
    void exercise1(string jointnames,double angle, float speed,int id)
    {
    ...
    void exercise2(vector<string> jointnames,vector<double> angle,vector<double> time_second,float speed)
    {
      ros::ServiceClient move_joint_client = nh_.serviceClient <nao_control_tutorial_1::MoveJoints>("Movejoints");
      nao_control_tutorial_1::MoveJoints srv;
...
int main(int argc, char** argv)
{
    ...
    /**************************************************************************************************************************************************************/
    /*Function1 
    /*for the EXERCISE1, It will bring the robot arm up what ever you tpye in the terminal
    /**************************************************************************************************************************************************************/
    //ic.exercise1("LShoulderPitch",-0.7,0.1,1);
    
    
    /*************************************************************************************************************************************************************/
    /*Funciton2
    /* for the EXERCISE2, It will move the robot depending on the method you choose 1 is for the SetAngles and 2 is for angleInterpolation
    /*************************************************************************************************************************************************************/
    vector<string> jointnames;
    ...
    //ic.exercise2(jointnames,angle,time_second,0.1);
